...
class TrackersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tracker" do
    assert_difference('Tracker.count') do
      post trackers_url, params: { tracker: { trackid: @tracker.trackid, trackinfo: @tracker.trackinfo } }
    end
  ...
  test "should update tracker" do
    patch tracker_url(@tracker), params: { tracker: { trackid: @tracker.trackid, trackinfo: @tracker.trackinfo } }
